Windows 12 网页版 Wiki
---
本仓库面向上游仓库[win12-online/win12](https://github.com/win12-online/win12)，由 `freedom-323` 维护，用于存取 Win12 项目的 Wiki 文档。

## 有关开发的一些事项
> [!Note]
>你会发现在本项目根目录有另一份 `READEME.md` 文件，先不要管它，我会在后文给出一个解释。
